// enrollment-pc/src/feature/align.h
// 5 点关键点相似变换对齐（ArcFace 标准 align）。
// 算法与 edge-box/src/face/face_align.h 保持一致（同一份 Umeyama 最小二乘 /
// ArcFace 112 目标坐标），仅依赖 C++17 标准库，便于录入端纯逻辑自测。
#pragma once
...
// 与 edge-box 完全一致，保证两端的 align 行为相同）
